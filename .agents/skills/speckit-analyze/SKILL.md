...
Inspect only `hooks.after_analyze` and handle each candidate under the Extension Hook Contract. Present the core result before hook candidates. Unconfirmed hooks are skipped and reported; no hook runs automatically.
