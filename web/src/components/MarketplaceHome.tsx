    ...
    content = (
      <div className="root-marketplace-empty">
        ...
        <div>
          ...
          <p>
            {locale === "en"
              ? "Search above, or browse the open stores below."
              : "可以在上方搜索，也可以浏览已营业店铺。"}
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="root-marketplace-main">
        ...
        >
          <header className="marketplace-hero-inner">
            <p className="marketplace-hero-kicker">
              {locale === "en" ? "MARKETPLACE" : "商城"}
            </p>
            <p className="marketplace-hero-brand">{brandName}</p>
