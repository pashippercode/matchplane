  ...
  return (
    ...
    >
      ...
      <div className="root-marketplace-main">
        <section
          className={`root-marketplace-entry marketplace-hero${searchTrace ? " has-results" : ""}`}
          aria-labelledby="root-marketplace-title"
        >
          <header className="root-marketplace-catalog-intro marketplace-hero-inner">
            <p className="marketplace-hero-kicker">
              {locale === "en" ? "MARKETPLACE" : "商城"}
            </p>
            <p className="root-marketplace-brand marketplace-hero-brand">
              {brandName}
            </p>
            ...
            <span className="marketplace-hero-support">
              {locale === "en"
