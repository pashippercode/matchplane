      ...
      >
        ...
        <div>
          ...
          <span>
            {accepted
              ? english
                ? "Once store staff also approve, the contact appears under Contact requests on this store page. You can keep chatting. Nothing is shared automatically."
                : "店员也同意后，可在本店铺页「联系申请」查看对方联系方式；你仍可继续与店长对话。平台不会自动展示或发送联系方式。"
              : english
                ? "No contact details were shared. You can keep chatting."
