...
# Runtime path is anchored to this script rather than the caller's directory.
# shellcheck disable=SC1091
source "$SCRIPT_DIR/common.sh"

# Get feature paths. Declare eval-populated variables so static analysis can
# verify every later filesystem path has a known assignment source.
